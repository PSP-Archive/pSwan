...
//
////////////////////////////////////////////////////////////////////////////////
#define WAV_BUF_LEN 32
#define A_AUDIO_NUM_DEVS	4
#define VOICE_SEQ_LEN 0x100
#define BUFSIZE 1024
#define AUDIO_ERROR_HANDLE 999

typedef struct {
	INT    iClock;
	BYTE   nVolume;		// AUDIOTRACK		ASetVoiceVolume()
	BYTE   nPanning;	// AUDIOSAMPLE		ASetVoicePanning()
	LONG   dwFrequency; // AUDIOTRACK		ASetVoiceFrequency()
	INT    iFormBef;
	BYTE   nWaveForm[WAV_BUF_LEN]; 
} A_AUDIO_VOICE_SEQ;

extern AUDIOINFO ainfo;
extern A_AUDIO_VOICE_SEQ voice_seq[A_AUDIO_NUM_DEVS][VOICE_SEQ_LEN];
extern BYTE nWaveFormTmp[A_AUDIO_NUM_DEVS][BUFSIZE];
extern BYTE nWaveForm[A_AUDIO_NUM_DEVS][2][WAV_BUF_LEN];
extern int cur_buf_pos[A_AUDIO_NUM_DEVS];
extern int pre_buf_pos[A_AUDIO_NUM_DEVS];
extern int bef[A_AUDIO_NUM_DEVS];
// PSP
